...
var (
	tutorials = [8][6][9]int{
		{ //1
			{BLUE, BLUE, LIGHT_BLACK, BLUE, BLUE, BLUE, BLUE, LIGHT_BLACK, LIGHT_BLACK},                              //front
			{ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, LIGHT_BLACK, LIGHT_BLACK, LIGHT_BLACK},                  //left
			{GREEN, GREEN, LIGHT_BLACK, GREEN, GREEN, LIGHT_BLACK, GREEN, GREEN, LIGHT_BLACK},                        //back
		...
		{ //2
			{BLUE, BLUE, LIGHT_BLACK, BLUE, BLUE, LIGHT_BLACK, BLUE, LIGHT_BLACK, LIGHT_BLACK},                        //front
			{ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, LIGHT_BLACK, LIGHT_BLACK, LIGHT_BLACK},                   //left
			{GREEN, GREEN, LIGHT_BLACK, GREEN, GREEN, LIGHT_BLACK, GREEN, GREEN, LIGHT_BLACK},                         //back
			{RED, RED, RED, RED, RED, LIGHT_BLACK, LIGHT_BLACK, RED, LIGHT_BLACK},                                     //right
			{LIGHT_BLACK, LIGHT_BLACK, LIGHT_BLACK, LIGHT_BLACK, YELLOW, LIGHT_BLACK, LIGHT_BLACK, BLUE, LIGHT_BLACK}, //top
			{WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE},                                           //bottom
		},
		{ //3
			{BLUE, BLUE, LIGHT_BLACK, BLUE, BLUE, YELLOW, BLUE, BLUE, LIGHT_BLACK},                 //front
			{ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, LIGHT_BLACK, YELLOW, LIGHT_BLACK},     //left
			{GREEN, GREEN, LIGHT_BLACK, GREEN, GREEN, YELLOW, GREEN, GREEN, LIGHT_BLACK},           //back
			{RED, RED, RED, RED, RED, RED, LIGHT_BLACK, YELLOW, LIGHT_BLACK},                       //right
			{LIGHT_BLACK, ORANGE, LIGHT_BLACK, GREEN, YELLOW, BLUE, LIGHT_BLACK, RED, LIGHT_BLACK}, //top
			{WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE},                        //bottom
		},
		{ //4
			{BLUE, BLUE, LIGHT_BLACK, BLUE, BLUE, GREEN, BLUE, BLUE, LIGHT_BLACK},                     //front
			{ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, LIGHT_BLACK, YELLOW, LIGHT_BLACK},        //left
			{GREEN, GREEN, LIGHT_BLACK, GREEN, GREEN, YELLOW, GREEN, GREEN, LIGHT_BLACK},              //back
			{RED, RED, RED, RED, RED, RED, LIGHT_BLACK, BLUE, LIGHT_BLACK},                            //right
		...
		{ //5
			...
			{GREEN, GREEN, GREEN, GREEN, GREEN, GREEN, LIGHT_BLACK, BLUE, LIGHT_BLACK},                  //left
			{RED, RED, LIGHT_BLACK, RED, RED, YELLOW, RED, RED, LIGHT_BLACK},                            //back
			{BLUE, BLUE, BLUE, BLUE, BLUE, BLUE, LIGHT_BLACK, RED, LIGHT_BLACK},                         //right
			{LIGHT_BLACK, YELLOW, LIGHT_BLACK, GREEN, YELLOW, ORANGE, LIGHT_BLACK, YELLOW, LIGHT_BLACK}, //top
			{WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE},                             //bottom
		},
		{ //6
			{BLUE, BLUE, LIGHT_BLACK, BLUE, BLUE, ORANGE, BLUE, BLUE, LIGHT_BLACK},                       //front
			{ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, LIGHT_BLACK, GREEN, LIGHT_BLACK},            //left
			{GREEN, GREEN, LIGHT_BLACK, GREEN, GREEN, BLUE, GREEN, GREEN, LIGHT_BLACK},                   //back
		...
		{ //7
			{BLUE, BLUE, LIGHT_BLACK, BLUE, BLUE, BLUE, BLUE, BLUE, RED},                            //front
			{ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, LIGHT_BLACK, ORANGE, LIGHT_BLACK},      //left
			{GREEN, GREEN, LIGHT_BLACK, GREEN, GREEN, GREEN, GREEN, GREEN, LIGHT_BLACK},             //back
			{RED, RED, RED, RED, RED, RED, LIGHT_BLACK, RED, GREEN},                                 //right
			{LIGHT_BLACK, YELLOW, LIGHT_BLACK, YELLOW, YELLOW, YELLOW, LIGHT_BLACK, YELLOW, YELLOW}, //top
			{WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE},                         //bottom
		},
		{ //8
			{GREEN, RED, RED, RED, RED, RED, YELLOW, RED, RED},                     //front
			{GREEN, GREEN, YELLOW, GREEN, GREEN, GREEN, GREEN, GREEN, GREEN},       //left
			{ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, ORANGE, BLUE, ORANGE, ORANGE}, //back
			{YELLOW, BLUE, RED, BLUE, BLUE, BLUE, BLUE, BLUE, BLUE},                //right
			{WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE},        //top
			{YELLOW, YELLOW, RED, YELLOW, YELLOW, YELLOW, ORANGE, YELLOW, BLUE},    //bottom
		},
	}
